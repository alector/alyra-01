const myText = `In cryptography, Alice and Bob are fictional characters commonly used as placeholders in discussions about cryptographic protocols or systems.
...
let newText = myText.replace('Alice', 'Panos')
